...
file=open(current_path+'/GPS_data.csv','r')
...
fig.update_layout(scene = dict(
                    ...
                    zaxis_title='weigh (Kg)'),
                    #width=700,
                    #margin=dict(r=20, b=10, l=10, t=10))
)
fig.update_layout(title="Weigh Map")
go_offline.plot(fig,filename=current_path+'3d_weigh_map.html',validate=True, auto_open=True)